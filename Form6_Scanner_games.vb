...
Public Class Form6_Scanner_games
    ...
    Private Sub Form6_Scanner_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'Fill combobox for choosing a boolean field used as 'Have' list and custom import option combobox to choose a db field
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If RadioButton1.Checked Then
            'Exodos mode
            Dim exodos_dir1 = TextBox1.Text + "\Games\" + ComboBox2.SelectedItem.ToString
            Dim exodos_dir2 = TextBox1.Text + "\eXoDOS\" + ComboBox2.SelectedItem.ToString
            Dim exodos_dir3 = TextBox1.Text + "\exo\eXoDOS\" + ComboBox2.SelectedItem.ToString
            ...
            If Not My.Computer.FileSystem.DirectoryExists(exodos_dir) Then
                ...
                If Not My.Computer.FileSystem.DirectoryExists(exodos_dir) Then
                    ...
                    If Not My.Computer.FileSystem.DirectoryExists(exodos_dir) Then
                        Dim msg = "Directory '" + ComboBox2.SelectedItem.ToString + "' not exits. " + vbCrLf
                        msg += "Tried in:" + vbCrLf
    ...
    Private Sub RadioButtonType_CheckedChanged(sender As Object, e As EventArgs) Handles RadioButton1.CheckedChanged, RadioButton2.CheckedChanged, RadioButton3.CheckedChanged
        ...
        TabPage1.Enabled = RadioButton2.Checked
        TabPage2.Enabled = RadioButton3.Checked

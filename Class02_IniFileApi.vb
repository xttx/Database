...
Public Class IniFileApi
    ...
    Public Function IniReadValue(Section As String, Key As String, Optional ignoreComments As Boolean = False) As String
        'Dim temp As New StringBuilder(255)
        Dim cur_length As Integer = 1024
        Dim got_length As Integer = 0
        Dim temp As String = Nothing
        While True
            temp = New String(" "c, cur_length - 1)
            got_length = GetPrivateProfileString(Section, Key, "", temp, cur_length - 1, path)
            If got_length >= cur_length - 2 Then cur_length *= 2 Else Exit While
        End While
        ...
        If Not ignoreComments AndAlso t.Contains("//") Then
